...
open(F, "/home/apple/d/毕业设计/tor-0.3.5.7-change-nolinkmsg/src/app/tor --list-torrc-options |") or die;
while (<F>) {
...
loadTorrc("/home/apple/d/毕业设计/tor-0.3.5.7-change-nolinkmsg/src/config/torrc.sample.in", \%torrcSampleOptions);

# Try to figure out what's in the man page.

my $considerNextLine = 0;
open(F, "/home/apple/d/毕业设计/tor-0.3.5.7-change-nolinkmsg/doc/tor.1.txt") or die;
while (<F>) {
